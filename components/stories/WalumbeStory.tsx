...
const WalumbeStory: React.FC = () => {
  ...
  const handleQuizSubmit = async () => { // Made async
    ...
    if (activeChild) {
      await saveActivity({
        ...
        // Updated activity name and details for Walumbe Story
  ...
  return (
    ...
    <StoryProgress
      storyId="walumbe" // Unique ID for this story
      storyTitle="The Tale of Walumbe" // Title for tracking
          ...
          <View style={styles.questionsContainer}>
            ...
            <View style={styles.quizContent}>
              ...
              <Text style={styles.quizTitle}>
                {quizCompleted ? `Your Score: ${score}/${storyQuestions.length}` : "The Tale of Walumbe - Quiz"}
              </Text>
