...
const MwangaStory: React.FC = () => {
  ...
  const handleQuizSubmit = async () => { // Made async
    ...
    if (activeChild) {
      await saveActivity({
        ...
        // Updated activity name and details for Mwanga Story
  ...
  return (
    ...
    <StoryProgress
      storyId="mwanga" // Unique ID for this story
      storyTitle="Kabaka Mwanga II" // Title for tracking
          ...
          <View style={styles.questionsContainer}>
            ...
            <View style={styles.quizContent}>
              ...
              <Text style={styles.quizTitle}>
                {quizCompleted ? `Your Score: ${score}/${storyQuestions.length}` : "Kabaka Mwanga II - Quiz"}
              </Text>
