...
export default function CanYourKidMatchNumbersToObjectsScreen() {
  ...
  const navigateToNextScreen = () => {
    // Navigate to the next screen (e.g., "Can your child figure out what's changed between two images?")
    router.push('/mindCapacity'); // Replace '/next-screen' with your actual route
  };

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Can Your Kid Match Numbers to Objects?</Text>
